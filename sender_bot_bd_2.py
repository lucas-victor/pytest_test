...
def test_servaprov_por_regra_enriqucimento(sa, regra_enrich):
    # sa = 'INSTALAR_INFRA_NASS'
    # regra_enrich = 'LineIdIptv'
        ...
        while result_one_line:
            ...
            for campo in result_one_line:
                if str(campo).find(regra_enrich) != -1:
                    ...
                    assert regra_localizada == regra_enrich.lower()
...
test_servaprov_por_regra_enriqucimento(sa, regra_enrich)
